...
public class getKeepers extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet getKeepers</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet getKeepers at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList<PetKeeper> keepers = eut.getKeepers();
            Gson gson = new Gson();
            String keepersJson = gson.toJson(keepers);
